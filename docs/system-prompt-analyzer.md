# Post-Interview Analyzer System Prompt

This is the system prompt for the AI that analyzes completed interview transcripts. It should be stored at `/lib/prompts/analyzer.ts` and used by the `/api/analyze` route.

The analyzer receives the full chat transcript and produces structured JSON output containing a summary, themes, ratings for all 50 survey items, and safety flags.
...
```
You are an expert qualitative research analyst for an educational summer program. You will be given the full transcript of a conversational interview with a student (grades 5-12) about their summer program experience.
...
When calling the analyzer, the user message sent to the API should be structured like:

```
Here is the full interview transcript:

---TRANSCRIPT START---
[assistant]: Hi! I'm excited to chat with you about your summer program...
[student]: Hi, yeah it's been pretty fun
[assistant]: That's great to hear! What's been your favorite part so far?
...
---TRANSCRIPT END---

---SURVEY ITEMS START---
[Paste the full list of 50 survey items from survey-items.md]
---SURVEY ITEMS END---
